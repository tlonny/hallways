...
use crate::hallways::game::state::menu::settings::Item;
...
use crate::hallways::settings::VsyncStatus;
use crate::hallways::sprite::text::character::TEXT_SIZE;
use crate::hallways::sprite::text::label::Alignment;
use crate::hallways::sprite::text::option::State;
use crate::hallways::sprite::text::{Character, Input, Label, Option as TextOption};
use crate::hallways::sprite::Border;
use crate::hallways::util;
use crate::hallways::util::keycode::Ext;
